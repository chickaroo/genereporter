...
class GRNPipeline:
    def __init__(self, wdir, adata, f_adj, f_reg, dir_gg_adj, gg_adj_files):
        """
        Initialize the GRNPipeline class.
        This function sets the working directory, loads the AnnData object, reads the adjacency and regulon data,
        gets the reactome, regulon genesets, and genesets, and reads the gene-gene adjacency files for different cell types.

        :param wdir: The working directory.
        :type wdir: str
        :param adata: The AnnData object.
        :type adata: AnnData
        :param f_adj: The adjacency file.
        :type f_adj: str
        :param f_reg: The regulon file.
        :type f_reg: str
        :param dir_gg_adj: The directory containing the gene-gene adjacency files.
        :type dir_gg_adj: str
        :param gg_adj_files: The gene-gene adjacency files.
        :type gg_adj_files: list of str
        """
    ...
    def genegene_importance_histograms(self, log_scale=False, xlim=10):
        """
        Generate histograms of gene gene adjacency importance scores for different cell types.
        This function generates histograms for B Cells, Epithelium Cells, Myeloid Cells, Stroma Cells, and T Cells.
        The histograms show the distribution of gene gene adjacency importance scores for each cell type.

        :param log_scale: Whether to use a logarithmic scale for the y-axis. Defaults to False.
        :type log_scale: bool
        :param xlim: The upper limit of the x-axis. Defaults to 10.
        :type xlim: int
        """
    ...
    def show_network(self, GOI: str, type: str ='gene_gene', top_n: int = 5) -> None:
        """
        Display the HTML content of a given file.
        This function reads an HTML file generated by either the make_goi_grn or make_gene_gene_network method,
        depending on the type parameter, and displays its content.

        :param GOI: The gene of interest.
        :type GOI: str
        :param type: The type of network to display, either 'regulon' or 'gene_gene'. Defaults to 'gene_gene'.
        :type type: str
        :param top_n: The number of top genes to include in the network. Defaults to 5.
        :type top_n: int
    """
        if type == 'regulon':
    ...
    def get_goi_pathways(self, GOI, method='spearman'):
        """
        This function calculates and ranks the correlation between each pathway's AUCell score
        and the expression of the gene of interest (GOI).
    ...
    def get_regulon_geneset(self, regulon=None) -> List[str]:
        """
        This function returns the gene set of a specific regulon.
        If no regulon is specified, it defaults to the first regulon in the list.
    ...
    def gGOSt_listed(self, GOI: str) -> str:
        """
        Print the list of top three significantly differentially expressed pathways in genes co expressed with the gene of interest (GOI), per cell lineage.
        This function uses the g:Profiler API to find the pathways in the REACTOME and KEGG databases that are significantly
        differentially expressed in genes co expressed with the GOI. It prints the top three pathways for each cell lineage.

        :param GOI: The gene of interest.
        :type GOI: str
        :return: A string message indicating the completion of the function.
        :rtype: str
        """
